...
import GU_Java.GU0011_10_Act01;

/**
 * Servlet implementation class GU0011_10_Servlet
 */
@WebServlet("/GU0011_10_Servlet")
public class GU0011_10_Servlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//インスタンス生成
		GU0011_10_Act01 objGU0011_10_Act01 = new GU0011_10_Act01();
		...
		//ここから各処理の実施を行う
		switch(reqAct) {
		case "fncSerchTorihiki":
			strRes = objGU0011_10_Act01.fncSerchTorihiki(reqData);
